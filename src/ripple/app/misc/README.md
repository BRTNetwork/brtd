...
A validating instance of brtd uses information in the configuration file
...
consensus to succeed, otherwise different instances of brtd will get
...
*  A pull request is created and the new code is folded into a brtd build
