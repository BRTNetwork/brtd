...
brtd's fee mechanism consists of several interrelated processes:
...
more (or less) work for brtd to process. Those transactions may have
...
but may not make sense if brtd is not synced to the network.
