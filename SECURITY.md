...
For more details on operating an XRP Ledger server securely, please visit https://xrpl.org/manage-the-brtd-server.html.
...
[BRT Network](https://brt.network) is generously sponsoring a bug bounty program for vulnerabilities in [`brtd`](https://github.com/BRTNetwork/brtd) (and other related projects, like [`ripple-lib`](https://github.com/ripple/ripple-lib)).
...
1. **In scope**. Only bugs in software under the scope of the program qualify. Currently, that means `brtd` and `ripple-lib`.
